...
app.get('/representatives', findAllRepresentatives, jsonResponse);
...
function findAllRepresentatives(req, res, next) {
  const url = `http://whoismyrepresentative.com/getall_reps_bystate.php?output=json`;
